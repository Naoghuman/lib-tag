 ...
 * @author Naoghuman
 */
public class TagComponentsProvider {
    
    private static final Optional<TagComponentsProvider> INSTANCE = Optional.of(new TagComponentsProvider());
    
    public static final TagComponentsProvider getDefault() {
        return INSTANCE.get();
    }
    
    private TagComponentsProvider() {
